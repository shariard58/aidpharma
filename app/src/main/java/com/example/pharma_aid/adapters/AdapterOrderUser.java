...
import com.example.pharma_aid.activites.OrderDetailsUsers;
...
public class AdapterOrderUser extends RecyclerView.Adapter<AdapterOrderUser.HolderOrderUser> {
    ...
    public void onBindViewHolder(@NonNull HolderOrderUser holder, int position) {
        ...
        //convert timestamp in proper order
        Calendar calendar=Calendar.getInstance();
        calendar.setTimeInMillis(Long.parseLong(orderTime));
        String formatedDate= DateFormat.format("dd/mm/yyyy",calendar).toString(); //e.g.22.2.2020
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, OrderDetailsUsers.class);
